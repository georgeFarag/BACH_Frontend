      ...
      import * as THREE from './threeM';
		...
		const WristPointOfRotation = new THREE.Vector3(0, 0.8, 0);
			...
			document.onkeydown = function (e) {
				switch (e.keyCode) {
					...
					case 38://foo2
						...
						if(!flagw){
						var geometry2 = wristmesh.geometry;
						geometry2.computeBoundingBox();
						cw = new THREE.Vector3();
						geometry2.boundingBox.getCenter(cw);
						wristmesh.localToWorld(cw);
						wristPosition.setFromMatrixPosition(wristmesh.matrixWorld);
						flagw=true;
						cw.x=0;
						// cw.z=0;
						console.log(cw)
						...
						//if (wristPosition.x <= 1)
							rotateAboutPoint(WristGroup, cw,xAxis, Math.PI/120);
